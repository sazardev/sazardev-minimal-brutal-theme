...
const carbonThemePalette = {
    ...
    indigo: {
        ...
        bestFor: ['Enterprise development', 'Long coding sessions', 'Team environments']
    },
    ...
    crimson: {
        ...
        bestFor: ['System programming', 'Backend development', 'Critical debugging']
    },
...
class CarbonThemeSelector {
    ...
    getThemeRecommendation(timeOfDay: 'morning' | 'afternoon' | 'evening' | 'night'): string {
    ...
    previewTheme(themeName: string): object {
